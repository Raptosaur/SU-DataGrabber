...
public class Timetable {
	...
	public static TimetableSlot[][] getUsersTimetable(User user, int year, int month, int day){
		TimetableSlot[][] modules = new TimetableSlot[9][5];
		
		try {
			Document doc = user.getPage("intranet/attendance/timetable/"+year+"/"+(month < 10 ? "0"+month : month)+"/"+(day < 10 ? "0"+day : day));
